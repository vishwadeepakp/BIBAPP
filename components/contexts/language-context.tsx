...
const translations: { [key in Language]: Translations } = {
  en: {
    ...
    'inventory.createWebsite': 'Create Website',
    'inventory.createEcommerce': 'Create Ecommerce',
    'inventory.addInventory': 'Add Inventory',
    'inventory.addStock': 'Add Stock',
    'inventory.barcodeScan': 'Barcode Scan',
    'inventory.aiBillScan': 'AI Bill Scan (OCR)',
    'inventory.loadError': 'Unable to load inventory from the backend right now.',
    'inventory.loading': 'Loading inventory...',
    'inventory.uncategorized': 'Uncategorized',
    'inventory.notAvailable': 'N/A',
  ...
  hi: {
    ...
    'inventory.brand': 'ब्रांड',
    'inventory.category': 'श्रेणी',
    'inventory.quantity_per_package': 'प्रति पैकेज',
    'inventory.unit': 'इकाई',
    'inventory.expiry': 'समाप्ति',
    'inventory.sku': 'SKU',
    'inventory.quantity': 'मात्रा',
    'inventory.sellPrice': 'बिक्री की मूल्य',
     'inventory.buyingPrice': 'बिक्री की मूल्य',
    'inventory.status': 'स्थिति',
    'inventory.stock': 'स्टॉक',
    'inventory.createEcommerce': 'एकोसमेंट बनाएं',
    'inventory.createWebsite': 'वेबसाइट बनाएं',
    'inventory.addInventory': 'इन्वेंटरी जोड़ें',
    'inventory.addStock': 'स्टॉक जोड़ें',
    'inventory.barcodeScan': 'बारकोड स्कैन',
    'inventory.aiBillScan': 'एआई बिल स्कैन (OCR)',
    'inventory.loadError': 'अभी इन्वेंटरी लोड नहीं की जा सकी।',
    'inventory.loading': 'इन्वेंटरी लोड हो रही है...',
    'inventory.uncategorized': 'श्रेणीबद्ध नहीं',
    'inventory.notAvailable': 'उपलब्ध नहीं',
    'inventory.noProducts': 'कोई उत्पाद नहीं मिला',
    'inventory.previous': 'पिछला',
    'inventory.next': 'अगला',
    'inventory.comingSoon': 'जल्द आ रहा है',
  ...
  mr: {
    ...
    'inventory.brand': 'ब्रँड',
    'inventory.category': 'श्रेणी',
    'inventory.quantity_per_package': 'प्रति पॅकेज',
    'inventory.unit': 'युनिट',
    'inventory.expiry': 'समाप्ति',
    'inventory.sku': 'SKU',
    ...
    'inventory.stock': 'स्टॉक',
    'inventory.createWebsite': 'वेबसाइट बनाएं',
    'inventory.createEcommerce': 'इकॉमर्स बनवा',
    'inventory.addInventory': 'इन्व्हेंटरी जोडा',
    'inventory.addStock': 'स्टॉक जोडा',
    'inventory.barcodeScan': 'बारकोड स्कॅन',
    'inventory.aiBillScan': 'एआय बिल स्कॅन (OCR)',
    'inventory.loadError': 'इन्व्हेंटरी आत्ता लोड करता आली नाही.',
    'inventory.loading': 'इन्व्हेंटरी लोड होत आहे...',
    'inventory.uncategorized': 'श्रेणीबद्ध नाही',
    'inventory.notAvailable': 'उपलब्ध नाही',
    'inventory.noProducts': 'कोणतेही उत्पाद सापडले नाहीत',
    'inventory.previous': 'मागील',
    'inventory.next': 'पुढील',
    'inventory.comingSoon': 'लवकरच येत आहे',
